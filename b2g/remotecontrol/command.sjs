...
/*
 * command.sjs is following of remote control service (bug 1197749).
 * While RemoteControlService receives an event, it creates a sandbox and eval command.sjs in the sandbox.
